...
작업일자 : 2026-08-03
작업자 : 김동욱
목적 : train.py로 만든 churn_model.joblib를 실제로 사용하는 사용자 화면 코드 (웹 페이지 화면), 시각적
...
st.caption("상담 우선 순위를 정하기 위한 의사결정 보고 도구이며, 예측만으로 불이익을 주면 안됩니다!")
...
with st.form("costomer"):
    ...
    # from_submit_button : 폼 안에서 유일하게 실행을 시작하게 하는 버튼
...
if submitted:
    ...
    # predict_proba(row): [[바이탈 확률, 이탈 확률]] 형태의 2차원 배열 반환
